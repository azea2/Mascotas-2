...
public class MiMascotaPerfilAdaptador extends RecyclerView.Adapter<MiMascotaPerfilAdaptador.MascotaViewHolder> {
    ...
    public MiMascotaPerfilAdaptador (ArrayList<Mascota> mascotas, Activity activity) {
    ...
    public MascotaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_mi_mascota_perfil, parent, false);
